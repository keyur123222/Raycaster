...
################################################################
# This is a generated script based on design: racaster_test
#
...
# source racaster_test_script.tcl
...
Reset#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins pixel_pusher_0/pixel]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins clock_div_25_0/clk] [get_bd_pins pixel_pusher_0/clk] [get_bd_pins rgb2dvi_0/SerialClk] [get_bd_pins vga_ctrl_0/clk]
  connect_bd_net -net clock_div_25_0_div [get_bd_pins clock_div_25_0/div] [get_bd_pins pixel_pusher_0/clk_enable] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins vga_ctrl_0/clk_enable]
  ...
  connect_bd_net -net pixel_pusher_0_addr [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins pixel_pusher_0/addr]
