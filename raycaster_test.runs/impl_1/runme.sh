...
HD_PWD='C:/Users/keyur/Documents/Vivado/raycaster_test/raycaster_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log racaster_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source racaster_test_wrapper.tcl -notrace
