...
HD_PWD='C:/Users/keyur/Documents/Vivado/raycaster_test/raycaster_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log racaster_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source racaster_test_wrapper.tcl
